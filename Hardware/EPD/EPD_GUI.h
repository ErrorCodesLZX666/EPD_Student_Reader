...
// void EPD_ShowPictureLVGLColor(u16 x,u16 y,u16 sizex,u16 sizey,lv_color_t* lvglColors,u16 Color);			//显示图片(lvgl颜色)    
...
// 定义支持汉字集合
#define EPD_SUPPORT_CN_FONT_12 1
#define EPD_SUPPORT_CN_FONT_16 1
#define EPD_SUPPORT_CN_FONT_24 1
#define EPD_SUPPORT_CN_FONT_32 1
